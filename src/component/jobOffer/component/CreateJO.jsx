...
function CreateJO() {
    ...
    const formik = useFormik({
        ...
        validationSchema: Yup.object({
            numOfRecruit: Yup.number().required().typeError("xin vui lòng nhập số"),
            offerEndTime: Yup.date().required().min(new Date(), "Ngày kết thúc phải lớn hơn ngày hiện tại"),
            salary: Yup.number().required().typeError("xin vui lòng nhập lương"),
            age: Yup.number().required().typeError("xin vui lòng nhập số tuổi"),
            startTime: Yup.string().required().typeError("xin vui lòng nhập giờ bắt đầu").min(1, "xin vui lòng nhập đúng định dạng giờ").max(24, "xin vui lòng nhập đúng định dạng giờ"),
            endTime: Yup.string().required().typeError("xin vui lòng nhập giờ kết thúc"),
            jobDescription: Yup.string().required().typeError("xin vui lòng nhập mô tả"),
            other: Yup.string(),
